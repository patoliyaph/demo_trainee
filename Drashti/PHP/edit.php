                    ...
                    <div class="update-form">
                        ...
                        <form action="" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data">
                            ...
                            <fieldset class="form-group">
                                <div class="stud-radio">
                                    <legend class="col-form-label col-sm-2 pt-0">Gender</legend>
                                    <input type="radio" class="stud-radio" id="male" name="gender" value="male" <?php if ($gender != "Male") echo "checked"; ?>>
                                    <label>Male</label>
                                    <input type="radio" class="stud-radio" id="Female" name="gender" value="Female" <?php if ($gender == "Female") echo "checked"; ?>>
                                    <label>Female</label> <span style="color:red"><?php echo $genderErr; ?></span>
                                </div><br>
                            </fieldset>
                            <div class="form-input">
                                <div class="mb-3">
                                    <label for="image" class="form-label">Image</label>
                                    <input class="form-control" type="file" id="image" value="<?php echo $row['image']; ?>" name="image" onchange="return fileValidation()"><br>
                                    <img src="upload/<?php echo $row['image']; ?>" id="img" width="100" height="100">
                                </div>
