                        ...
                        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
                            ...
                            <fieldset class="form-group">
                                <div class="stud-radio">
                                    ...
                                    <input type="radio" class="stud-radio" id="male" name="gender" value="Male" <?php echo ($gender == 'Male') ? 'checked' : ''; ?>>
                                    <label>Male</label>
                                    <input type="radio" class="stud-radio" id="Female" name="gender" value="Female" <?php echo ($gender == 'Female') ? 'checked' : ''; ?>>
                            ...
                            <div class="form-input">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="file" id="formFile" name="image" onchange="return fileValidation()">
                                </div>
                                <div class="preview">
