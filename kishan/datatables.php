...
<?php
            if($_SESSION["email"]){
        ?>
welcome <?php echo $_SESSION["email"];?>.click herer to <a href="logout.php" title="Logout"
    class="btn btn-warning ms-2">Logout.</a>
<?php
            }else{ 
        ...
        <div class="row justify-content-center">
            ...
            ?>
                            <tr style="background-color:#f2f2f2;">
                                ...
                                <td>
                                    <button
                                        class="btn btn-outline-warning"><?php echo '<a href="view.php?id='.$row['id'].'" style="text-decoration:none;"/>'?>view</button>
                                    <button
                                        class="btn btn-outline-warning"><?php echo '<a href="edit.php?id='.$row['id'].'" style="text-decoration:none;"/>'?>edit</button>
