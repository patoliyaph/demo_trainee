...
<body
    style="background-image: linear-gradient(43deg, #4158D0 0%, #C850C0 46%, #FFCC70 100%);background-size:cover;background-repeat:no-repeat;background-attachment:fixed;">
                    ...
                    <div class="signupFrm">
                        <form method="post" enctype="multipart/form-data" action="" id="updateForm">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="name" value=<?php echo  $userdata['name'];?> class="input"
                                        id="name">
                                        <?php echo $error_name;?>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="password" name="password" value=<?php echo $userdata['password'];?>
                                        class="input" onKeyUp="checkPasswordStrength();" id="password">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="password" name="Cpassword" value=<?php echo $userdata['password'];?>
                                        class="input" id="Cpassword">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <select name="gender" id="gender">
                                        ...
                                        <option class="input"
                                            <?php if( $userdata['gender'] == 'male'){echo 'selected="selected"';}?>
                                            value="male">male</option>
                                        <option
                                            <?php if( $userdata['gender'] == 'female'){echo 'selected="selected"';}?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="file" name="photo" class="input" id="photo"
