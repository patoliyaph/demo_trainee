                ...
                <form method="POST" enctype="multipart/form-data" id="loginForm">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label for="email" class="col-lg-3 col-form-label form-control-label" style="padding-left:90px;">email:</label>
                            <div class="col-lg-6">
                                <input type="email" name="email" placeholder="enter your email address" class="input form-control">
                                <?php echo $error_email ?>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="password" class="col-lg-3 col-form-label form-control-label" style="padding-left:90px;">pwd:</label>
                            <div class="col-lg-6">
